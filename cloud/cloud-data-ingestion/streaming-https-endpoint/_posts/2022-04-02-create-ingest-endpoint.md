...
Only sources in the "ACTIVE" state can have data pushed for ingest. To learn more about pushing data, click [here](/cloud/cloud-data-ingestion/streaming-https-endpoint/stream-ingest-endpoint).

* [Ingest endpoint API](https://api-docs-featurebase-cloud.redoc.ly/v2#tag/Data-Sources).
