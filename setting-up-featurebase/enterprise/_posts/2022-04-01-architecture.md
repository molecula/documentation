...
Optionally, FeatureBase listens on port 55342 for the PostgreSQL wire protocol. It can accept [PQL](/data-querying/pql) queries, or a [subset of SQL](/data-querying/sql) over this protocol.
