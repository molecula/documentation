...
### Pilosa Rename
Pilosa was renamed to FeatureBase. For details, refer to the [FeatureBase Rename](/community/featurebase-rename) page.
...
For additional details on the new configuration, refer to the [FeatureBase Configuration](/community/community-setup/featurebase-configuration)
...
Changes to the data directory structure in FeatureBase were made to account for RBF and etcd changes. For details, refer to the [Data Directory Structure](/community/data-directory-structure). In general, the Molecula team would like to discourage reliance on any particular details of the directory structure. 
...
Instructions for setting up FeatureBase are in the [How to Install FeatureBase](/community/community-setup/installing-featurebase). Also, refer to the [FeatureBase Configuration](/community/community-setup/featurebase-configuration) for additional details. This stop is not necessarily dependent on the previous 3, and if your environment allows this, you'll probably want to do this first to minimize downtime.
