...
Optionally, FeatureBase listens on port 55342 for the PostgreSQL wire protocol. It can accept [PQL](/pql-guide/pql-introduction) queries, or a [subset of SQL](/sql-guide/sql-introduction) over this protocol.
