...
Deprecation Notice! Inspect remains available in Molecula 3.x, but is now deprecated in favor of the [Extract PQL Query](/reference/data-querying-ref/pql/read/extract).
:::
